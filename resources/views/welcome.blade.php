        ...
        <div class="top-menu-wrapper">
            <div class="menu-dropdown">
                ...
                <div class="dropdown-content" id="dropdownContent">
                    ...
                    <a href="{{ route('public.layanan.index') }}">Layanan</a>
                    <a href="{{ route('public.pengumuman.index') }}">Pengumuman</a>
                    <a href="{{ route('public.galeri.index') }}">Galeri</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="media-update-section">
    <div class="container">
        ...
        <div class="media-grid">
            ...
            <div class="media-card">
                <div class="media-image">
                    @if($berita->gambar_utama) <img src="{{ asset('storage/'.$berita->gambar_utama) }}" alt="{{ $berita->judul }}"> @else <div class="media-placeholder"></div> @endif
                </div>
        ...
        <div class="text-center"><a href="{{ route('berita.index') }}" class="btn-primary">Lihat Lebih Banyak</a></div>
    </div>
</section>
...
<section class="layanan-section">
    <div class="container">
        ...
        @if($layanans && $layanans->count() > 0)
        <div class="layanan-grid-2x2">
            @foreach($layanans->take(4) as $layanan)
            <a href="{{ route('public.layanan.show', $layanan->slug) }}" class="layanan-card">
                <div class="layanan-icon-box">
                    @php $name = Str::lower($layanan->nama_layanan); @endphp
                    @if(Str::contains($name, 'skck')) <img src="{{ asset('assets/icons/skck.png') }}" class="layanan-icon-img">
                    @elseif(Str::contains($name, 'samsat')) <img src="{{ asset('assets/icons/samsat.png') }}" class="layanan-icon-img">
                    @elseif(Str::contains($name, 'sim')) <img src="{{ asset('assets/icons/sim.jpg') }}" class="layanan-icon-img">
                    @elseif(Str::contains($name, '110')) <img src="{{ asset('assets/icons/Layanan110.png') }}" class="layanan-icon-img">
                    @endif
                </div>
            ...
            <marquee onmouseover="this.stop();" onmouseout="this.start();">
                @foreach($pengumumans as $p)
                    <a href="{{ route('public.pengumuman.index') }}">
                        <i class="fas fa-bullhorn text-warning me-2"></i><strong>{{ $p->judul }}:</strong> {{ Str::limit(strip_tags($p->isi_pengumuman), 100) }}
                    </a>
                @endforeach
            </marquee>
        </div>
