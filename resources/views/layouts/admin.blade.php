...
<head>
    ...
    <title>@yield('title', 'Admin') - Humas Polres Bangkalan</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar">
            ...
            <nav class="nav flex-column">
                ...
                {{-- Profil Polres --}}
                @if(Route::has('admin.profil.edit'))
                ...
                {{-- Pengumuman --}}
                <a class="nav-link {{ request()->routeIs('admin.pengumuman.*') ? 'active' : '' }}" 
                ...
                {{-- Album Foto (Galeri) --}}
                <a class="nav-link {{ request()->routeIs('admin.album.*') ? 'active' : '' }}" 
