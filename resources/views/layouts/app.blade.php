...
<head>
    ...
    <title>@yield('title', 'Humas Polres Bangkalan')</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('public.layanan.*') ? 'active' : '' }}" href="{{ route('public.layanan.index') }}">
                            <i class="fas fa-concierge-bell"></i> Layanan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('public.pengumuman.*') ? 'active' : '' }}" href="{{ route('public.pengumuman.index') }}">
                            <i class="fas fa-bullhorn"></i> Pengumuman
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('public.galeri.*') ? 'active' : '' }}" href="{{ route('public.galeri.index') }}">
            ...
            <div class="running-text-container">
                ...
                <div class="running-text-content">
                    <marquee behavior="scroll" direction="left" scrollamount="5">
                        @foreach($runningPengumumans as $pengumuman)
                            <a href="{{ route('public.pengumuman.show', $pengumuman->id_pengumuman) }}" class="running-text-item">
                                <i class="fas fa-circle-notch fa-xs"></i> {{ $pengumuman->judul }}
                            </a>
                            @if(!$loop->last) • @endif
                        @endforeach
                    </marquee>
    ...
    {{-- Footer - EXACT from welcome.blade.php --}}
    @unless(request()->is('admin*'))
    <footer class="footer">
        <div class="container">
    ...
    {{-- DARK MODE SYNC - EXACT from welcome.blade.php --}}
    <script>
