...
<?php $__env->startSection('title', 'Layanan Polres Bangkalan'); ?>
...
<div class="container py-5">
    ...
    <?php if(isset($layanans) && $layanans->count() > 0): ?>
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3">
            <a href="<?php echo e(route('public.layanan.show', $layanan->slug)); ?>" class="text-decoration-none">
                <div class="card layanan-card h-100 border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        <div class="layanan-icon mb-3">
                            ...
                            <?php if($icon): ?>
                                <img src="<?php echo e(asset('assets/icons/' . $icon)); ?>" 
                        ...
                        <h5 class="card-title fw-bold mb-2"><?php echo e($layanan->nama_layanan); ?></h5>
                        <?php if($layanan->deskripsi_singkat): ?>
                            <p class="card-text text-muted small"><?php echo e(Str::limit($layanan->deskripsi_singkat, 80)); ?></p>
                        <?php endif; ?>
                        <div class="mt-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\humas-polres-bangkalan\resources\views/public/layanan-list.blade.php ENDPATH**/ ?>